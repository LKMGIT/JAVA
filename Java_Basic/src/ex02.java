...
public class ex02 { // public은 class ex01 {} 이라는 클래스는 누구나 접근할 수 있는 public 클래스이다. (접근제한자)
    ...
    public static void main(String[] args) { // main 메서드. 메서드란? -> 기능단위라고 생각.
        ...
        // ========== Quiz2 ===========
        // 3개의 정수를 사용자에게 입력 받아 더하여 결과를 출력하세요

        int a; int b; int c; int sum;    // 내가 사용할 변수를 먼저 선언 해주는 게 좋음

        Scanner sc = new Scanner(System.in);  //사용자에게 키보드로 입력을 받을 수 있는 Scanner 객체를 생성
